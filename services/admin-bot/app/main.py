"""
Admin Bot Service - Main Application
Telegram bot for game administrators
"""
...
from .handlers import admin_handlers, game_handlers, session_handlers, validation_handlers
...
async def create_dispatcher() -> Dispatcher:
    ...
    dp.include_router(validation_handlers.router)
...
async def on_startup(bot: Bot) -> None:
    """Bot startup handler"""
    logger.info("Admin Bot starting up")
...
async def on_shutdown(bot: Bot) -> None:
    ...
    logger.info("Admin Bot shutting down")
...
async def main():
    ...
    if settings.WEBHOOK_URL:
        ...
        logger.info(f"Admin Bot webhook server started on {settings.API_HOST}:{settings.API_PORT}")
